...
<div class="form-group">
    ...
    <select class="form-control" id="category" v-model="form.category_id">
      <option v-for="category in this.categories" :value="category.id" :key="category.id">{{category.categoryname}}</option>
    </select>
  </div>
  <div class="form-group">
    ...
    <select class="form-control" id="subcategory" v-model="form.subcategory_id">
      <option v-for="subcategory in filteredSubcategories"  :value="subcategory.id" :key="subcategory.id">{{subcategory.subcategoryname}}</option>
    </select>
  </div>
            <div class="form-row">
